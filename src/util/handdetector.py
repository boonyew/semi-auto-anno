    ...
    def detectFromCache(self, cache_name, name, cache_str=''):
        ...
        if cache_str != '':
            ...
            for line in cache_str:
                ...
                if isinstance(name, str) and os.path.normpath(part[0]).split(os.path.sep)[-1] == os.path.normpath(name).split(os.path.sep)[-1] and os.path.normpath(part[0]).split(os.path.sep)[-2] == os.path.normpath(name).split(os.path.sep)[-2]:
                    assert len(part) == 4
